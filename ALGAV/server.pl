...
create_city(Request):-
        ...
        (create_city(Id, Name), reply_json(_, [status(200)]), !);
...
update_city(Request):-
        ...
        http_read_json_dict(Request, DictIn),
        Id = DictIn.get(id), Name = DictIn.get(name),
        (update_city(Id, Name), reply_json(_,  [status(200)]), !);
        reply_json(_, [status(500)]).
...
create_truck(Request):-
        ...
        (create_truck(Id, Tare, Capacity, BateryCapacity, Autonomy,TimeToCharge), reply_json(_,  [status(200)]), !);
        reply_json(_, [status(500)]).
...
update_truck(Request):-
        ...
        http_read_json_dict(Request, DictIn),
        Id = DictIn.get(id), Tare = DictIn.get(tare), Capacity = DictIn.get(capacity), BateryCapacity = DictIn.get(baterycapacity), Autonomy = DictIn.get(autonomy), TimeToCharge = DictIn.get(timeToCharge),
        (update_truck(Id, Tare, Capacity, BateryCapacity, Autonomy,TimeToCharge), reply_json(_,  [status(200)]), !);
        reply_json(_, [status(500)]).
...
create_delivery(Request):-
        ...
        (create_delivery(Id, Date, Mass, Destination, LoadTime, UnloadTime), reply_json(_,  [status(200)]), !);
        reply_json(_, [status(500)]).
...
update_delivery(Request):-
        ...
        http_read_json_dict(Request, DictIn),
        Id = DictIn.get(id), Date = DictIn.get(date), Mass = DictIn.get(deliveryMass), Destination = DictIn.get(destination), LoadTime = DictIn.get(loadTime), UnloadTime = DictIn.get(unloadTime),
        (update_delivery(Id, Date, Mass, Destination, LoadTime, UnloadTime), reply_json(_,  [status(200)]), !);
        reply_json(_, [status(500)]).
...
create_path(Request):-
        ...
        (create_path(Truck, CityOrig, CityDest, PathTime, Energy, AditionalTime), reply_json(_,  [status(200)]), !);
        reply_json(_, [status(500)]).
...
update_path(Request):-
        ...
        (update_path(OldCityOrig, OldCityDest, Truck = DictIn.get(truck), PathTime, Energy, AditionalTime), reply_json(_,  [status(200)]), !);
        reply_json(_, [status(500)]).
