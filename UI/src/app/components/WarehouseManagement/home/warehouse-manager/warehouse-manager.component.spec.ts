...
describe('WarehouseManagerComponent', () => {
  ...
  it('go to create warehouse', () => {
    component.goToCreateWarehouse();
    expect(component).toBeTruthy();
  });

  it('go to create delivery', () => {
    component.goToCreateDelivery();
    expect(component).toBeTruthy();
  });

  it('go to get warehouse by id', () => {
    component.goToGetWarehouseById();
    expect(component).toBeTruthy();
  });

  it('go to get delivery', () => {
    component.goToGetDelivery();
    expect(component).toBeTruthy();
  });

  it('go to edit warehouse', () => {
    component.goToEditWarehouse();
    expect(component).toBeTruthy();
  });
