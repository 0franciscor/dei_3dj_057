...
export default class NodeTemplate {
    ...
    constructor(pos: number[], connections: any[][], allWidths: number[]) {
        ...
        let geometry = new THREE.CircleGeometry(circleWidth * 2, 32);
        ...
        let cube: THREE.Mesh = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 1), new THREE.MeshBasicMaterial({ color: 0xFFFFFF }));
        cube.position.set(pos[0], pos[1], pos[2]);
        //this.object.add(cube);

        const objLoader = new FBXLoader();
        objLoader.load('src/app/assets/warehouse/source/industrialMill.fbx',
            (object) => {
        ...
        //i want to use the texture i previously loaded with the objLoader
